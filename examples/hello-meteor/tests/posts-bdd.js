...
describe('Posts in BDD Style', function() {
  lit('insert in client and observe in client too', function(done, server, c1, c2) {
  ...
  lit('insert and observe2', function(done, server, client) {
    server.eval(function() {
      Posts.remove({});
      Posts.find().observe({
        added: notifyTest
  ...
  lit('insert in client and observe in client too using evalSync()', function(done, server, c1, c2) {
    var insertObject = { k: Math.random() };
